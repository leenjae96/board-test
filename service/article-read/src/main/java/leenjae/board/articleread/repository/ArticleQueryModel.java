...
import leenjae.board.articleread.client.ArticleClient;
...
public class ArticleQueryModel {
    ...
    public static ArticleQueryModel create(ArticleClient.ArticleResponse article, Long commentCount, Long likeCount) {
        ...
        articleQueryModel.createdAt = LocalDateTime.now();
        articleQueryModel.modifiedAt = LocalDateTime.now();
    ...
    public void updateBy(ArticleUpdatedEventPayload payload) {
        ...
        this.createdAt = payload.getCreatedAt(); // TODO: check this.
