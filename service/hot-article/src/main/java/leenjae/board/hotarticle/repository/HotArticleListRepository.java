...
public class HotArticleListRepository {
    ...
    private String generateKey(String dateSrc) {
        return KEY_FORMAT.formatted(dateSrc);
    }

    public List<Long> readAll(String dateSrc) {
        return redisTemplate.opsForZSet()
                .reverseRangeWithScores(generateKey(dateSrc), 0, -1).stream()
                .peek(tuple ->
