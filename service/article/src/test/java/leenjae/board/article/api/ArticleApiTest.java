package leenjae.board.article.api;
...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(165625201034600448L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 165625201034600448L)
                .retrieve();
    }
