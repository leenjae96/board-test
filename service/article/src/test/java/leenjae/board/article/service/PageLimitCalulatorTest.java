package leenjae.board.article.service;

import org.junit.jupiter.api.Test;

import static org.assertj.core.api.Assertions.assertThat;

class PageLimitCalulatorTest {
    ...
    void calculatePageLimitTest() {
        ...
        calculatePageLimit(13L, 30L, 10L, 601L);


    }

    void calculatePageLimit(Long page, Long pageSize, Long movablePageCount, Long expected) {
        Long result = PageLimitCalulator.calculatePageLimit(page, pageSize, movablePageCount);
