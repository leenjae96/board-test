...
public class CommentApiTest {
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("v1/comments/{commentId}", 169728876900179968L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    @Test
    void delete() {
        //commentId=169728876900179968 - x
        //  commentId=169728877789372416
        //  commentId=169728877852286976

        restClient.delete()
                .uri("v1/comments/{commentId}", 169728877852286976L)
                .retrieve();
    }
    ...
    void readAll() {
        ...
        comment.getCommentId() = 169731484409978880
            comment.getCommentId() = 169731484489670669
        comment.getCommentId() = 169731484409978881
            comment.getCommentId() = 169731484489670663
        comment.getCommentId() = 169731484409978882
            comment.getCommentId() = 169731484489670662
        comment.getCommentId() = 169731484409978883
            comment.getCommentId() = 169731484489670664
        comment.getCommentId() = 169731484409978884
            comment.getCommentId() = 169731484489670657
         */
    }
